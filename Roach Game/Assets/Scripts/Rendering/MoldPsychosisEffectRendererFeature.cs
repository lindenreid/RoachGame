...
public sealed class MoldPsychosisEffectRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        MoldPsychosisEffectVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<MoldPsychosisEffectVolumeComponent>();
    ...
    private class CustomPostRenderPass : ScriptableRenderPass
    {
        ...
        private static void ExecuteMainPass(RasterCommandBuffer cmd, RTHandle sourceTexture, Material material)
        {
            ...
            if (myVolume != null)
            {
                s_SharedPropertyBlock.SetInt("_UseVideo1", myVolume.useVideo1.value? 1 : 0);
                s_SharedPropertyBlock.SetInt("_UseVideo2", myVolume.useVideo2.value? 1 : 0);
                s_SharedPropertyBlock.SetInt("_UseVideo3", myVolume.useVideo3.value? 1 : 0);
                s_SharedPropertyBlock.SetInt("_UseWhiteBackground", myVolume.useWhiteBackground.value? 1 : 0);
                s_SharedPropertyBlock.SetFloat("_ChromaticAbberation", myVolume.chromaticAbberation.value);
                s_SharedPropertyBlock.SetFloat("_VoronoiSpeed", myVolume.voronoiSpeed.value);
                s_SharedPropertyBlock.SetFloat("_VoronoiDensity", myVolume.voronoiDensity.value);
                s_SharedPropertyBlock.SetInt("_UseMold", myVolume.useMold.value? 1 : 0);
                s_SharedPropertyBlock.SetFloat("_MoldCoverage", (1.0f - myVolume.moldCoverage.value)*15.0f);
                s_SharedPropertyBlock.SetTexture("_VideoRenderTex1", myVolume.video1Tex.value);
                s_SharedPropertyBlock.SetTexture("_VideoRenderTex2", myVolume.video2Tex.value);
                s_SharedPropertyBlock.SetTexture("_VideoRenderTex3", myVolume.video3Tex.value);
            }
